...
echo "Creating LF0 role..."
aws iam create-role --role-name LF0-ExecutionRole --assume-role-policy-document file://trust-policy.json
aws iam put-role-policy --role-name LF0-ExecutionRole --policy-name LF0-Policy --policy-document file://lf0-policy.json

echo "Creating LF1 role..."
aws iam create-role --role-name LF1-ExecutionRole --assume-role-policy-document file://trust-policy.json
aws iam put-role-policy --role-name LF1-ExecutionRole --policy-name LF1-Policy --policy-document file://lf1-policy.json

echo "Creating LF2 role..."
aws iam create-role --role-name LF2-ExecutionRole --assume-role-policy-document file://trust-policy.json
aws iam put-role-policy --role-name LF2-ExecutionRole --policy-name LF2-Policy --policy-document file://lf2-policy.json

echo "Done! Getting role ARNs..."
...
# Cleanup
rm trust-policy.json lf0-policy.json lf1-policy.json lf2-policy.json